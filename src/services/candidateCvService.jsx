...
export default class CandidateCvService {
    getById(id){
        return axios.get(`https://javareactcamp-hrms-frontend.herokuapp.com/api/cvs/getById?id=${id}`)
    }

    add(values){
        return axios.post("https://javareactcamp-hrms-frontend.herokuapp.com/api/cvs/add",values)
    }

    delete(cvId){
        return axios.delete(`https://javareactcamp-hrms-frontend.herokuapp.com/api/cvs/deleteById?id=${cvId}`)
    }

    updateTitle(id, title){
        return axios.put(`https://javareactcamp-hrms-frontend.herokuapp.com/api/cvs/updateTitle?id=${id}&title=${title}`)
    }

    updateCoverLetter(id, coverLetter){
        if(!coverLetter) return axios.put(`https://javareactcamp-hrms-frontend.herokuapp.com/api/cvs/updateCoverLetter?id=${id}`)
        return axios.put(`https://javareactcamp-hrms-frontend.herokuapp.com/api/cvs/updateCoverLetter?coverLetter=${coverLetter}&id=${id}`)
    }
    ...
    updateJobExperiences(id, jobExperienceIds, updateType){
        ...
        let request = `https://javareactcamp-hrms-frontend.herokuapp.com/api/cvs/${updateExp}/JobExperiences?candidateCvId=${id}`
    ...
    updateLanguages(id, languageIds, updateType){
        let updateExp
        updateType === "delete" ? updateExp = "deleteFromCandidateCv": updateExp = "addToCandidateCv"
        let request = `https://javareactcamp-hrms-frontend.herokuapp.com/api/cvs/${updateExp}/Languages?candidateCvId=${id}`
    ...
    updateSchools(id, schoolIds, updateType){
        let updateExp
        updateType === "delete" ? updateExp = "deleteFromCandidateCv": updateExp = "addToCandidateCv"
        let request = `https://javareactcamp-hrms-frontend.herokuapp.com/api/cvs/${updateExp}/Schools?candidateCvId=${id}`
    ...
    updateSkills(id, skillIds, updateType){
        let updateExp
        updateType === "delete" ? updateExp = "deleteFromCandidateCv": updateExp = "addToCandidateCv"
        let request = `https://javareactcamp-hrms-frontend.herokuapp.com/api/cvs/${updateExp}/Skills?candidateCvId=${id}`
